<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <div class="form-group">
            {{ Form::label('cantidad') }}
            {{ Form::text('cantidad', $pelicula->cantidad, ['class' => 'form-control' . ($errors->has('cantidad') ? ' is-invalid' : ''), 'placeholder' => 'Cantidad']) }}
            {!! $errors->first('cantidad', '<div class="invalid-feedback">:message</div>') !!}
        </div>
        <div class="form-group">
            {{ Form::label('Anio') }}
            {{ Form::text('Anio', $pelicula->Anio, ['class' => 'form-control' . ($errors->has('Anio') ? ' is-invalid' : ''), 'placeholder' => 'Anio']) }}
